...
{
    loadEventData();
    talk_box_ = std::make_shared<Element>();
...
bool Event::callEvent(int event_id, Element* subscene, int supmap_id, int item_id, int event_index, int x, int y)
{
    ...
    Element::addOnRootTop(talk_box_.get());
    int p = 0;
    loop_ = true;
    int i = 0;
...
#define PRINT_E(n)                                                         \
    do                                                                     \
    {                                                                      \
        for (int __i = 1; __i <= n; __i++) { printf("%d, ", e[i + __i]); } \
        printf("\b\b  \n");                                                \
    } while (0)
#define VOID_0(function) \
    {                    \
        PRINT_E(0);      \
        function();      \
        i += 1;          \
    }
#define VOID_1(function)    \
    {                       \
        PRINT_E(1);         \
        function(e[i + 1]); \
        i += 2;             \
    }
#define VOID_2(function)              \
    {                                 \
        PRINT_E(2);                   \
        function(e[i + 1], e[i + 2]); \
        i += 3;                       \
    }
#define VOID_3(function)                        \
    {                                           \
        PRINT_E(3);                             \
        function(e[i + 1], e[i + 2], e[i + 3]); \
        i += 4;                                 \
    }
#define VOID_4(function)                                  \
    {                                                     \
        PRINT_E(4);                                       \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4]); \
        i += 5;                                           \
    }
#define VOID_5(function)                                            \
    {                                                               \
        PRINT_E(5);                                                 \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5]); \
        i += 6;                                                     \
    }
#define VOID_6(function)                                                      \
    {                                                                         \
        PRINT_E(6);                                                           \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6]); \
        i += 7;                                                               \
    }
#define VOID_7(function)                                                                \
    {                                                                                   \
        PRINT_E(7);                                                                     \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7]); \
        i += 8;                                                                         \
    }
#define VOID_8(function)                                                                          \
    {                                                                                             \
        PRINT_E(8);                                                                               \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7], e[i + 8]); \
        i += 9;                                                                                   \
    }
#define VOID_9(function)                                                                                    \
    {                                                                                                       \
        PRINT_E(9);                                                                                         \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7], e[i + 8], e[i + 9]); \
        i += 10;                                                                                            \
    }
#define VOID_10(function)                                                                                              \
    {                                                                                                                  \
        PRINT_E(10);                                                                                                   \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7], e[i + 8], e[i + 9], e[i + 10]); \
        i += 11;                                                                                                       \
    }
#define VOID_11(function)                                                                                                                  \
    {                                                                                                                                      \
        PRINT_E(11); function((e[i+1],e[i+2],e[i+3],e[i+4],e[i+5],e[i+6],e[i+7],e[i+8],e[i+9],e[i+10],e[i+11]); i+=12; \
    }
#define VOID_12(function)                                                                                                                    \
    {                                                                                                                                        \
        PRINT_E(12);                                                                                                                         \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7], e[i + 8], e[i + 9], e[i + 10], e[i + 11], e[i + 12]); \
        i += 13;                                                                                                                             \
    }
#define VOID_13(function)                                                                                                                               \
    {                                                                                                                                                   \
        PRINT_E(13);                                                                                                                                    \
        function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5], e[i + 6], e[i + 7], e[i + 8], e[i + 9], e[i + 10], e[i + 11], e[i + 12], e[i + 13]); \
        i += 14;                                                                                                                                        \
    }

#define BOOL_0(function)                   \
    {                                      \
        PRINT_E(0);                        \
        if (function()) { i += e[i + 1]; } \
        else                               \
...
#define BOOL_1(function)                           \
    {                                              \
        PRINT_E(1);                                \
        if (function(e[i + 1])) { i += e[i + 2]; } \
        else                                       \
        {                                          \
            i += e[i + 3];                         \
        }                                          \
...
#define BOOL_2(function)                                     \
    {                                                        \
        PRINT_E(2);                                          \
        if (function(e[i + 1], e[i + 2])) { i += e[i + 3]; } \
        else                                                 \
        {                                                    \
            i += e[i + 4];                                   \
        }                                                    \
...
#define BOOL_2_2(function)                                   \
    {                                                        \
        PRINT_E(2);                                          \
        if (function(e[i + 1], e[i + 4])) { i += e[i + 2]; } \
        else                                                 \
        {                                                    \
            i += e[i + 3];                                   \
        }                                                    \
...
#define BOOL_3(function)                                               \
    {                                                                  \
        PRINT_E(3);                                                    \
        if (function(e[i + 1], e[i + 2], e[i + 3])) { i += e[i + 4]; } \
        else                                                           \
        {                                                              \
            i += e[i + 5];                                             \
        }                                                              \
...
#define BOOL_4(function)                                                                          \
    {                                                                                             \
        PRINT_E(4);                                                                               \
        if (function(e[i + 1], e[i + 2], e[i + 3], e[i + 4]))) {i += e[i+5];} \
        else                                                                                      \
        {                                                                                         \
            i += e[i + 6];                                                                        \
        }                                                                                         \
...
#define BOOL_5(function)                                                                   \
    {                                                                                      \
        PRINT_E(5);                                                                        \
        if (function(e[i + 1], e[i + 2], e[i + 3], e[i + 4], e[i + 5])) { i += e[i + 6]; } \
        else                                                                               \
        {                                                                                  \
            i += e[i + 7];                                                                 \
        }                                                                                  \
...
#define RUN_INSTRUCT(function, INSTRUCT_TYPE) \
    do                                        \
    {                                         \
        printf("%s: ", #function);            \
        INSTRUCT_TYPE(function);              \
    } while (0)
#define REGISTER_INSTRUCT(code, function, INSTRUCT_TYPE)       \
    {                                                          \
    case (code): RUN_INSTRUCT(function, INSTRUCT_TYPE); break; \
    }
    ...
    Element::removeFromRoot(talk_box_.get());
    clearTalkBox();
    if (subscene_)
    {
